...
public class ScheduleRepository {
    ...
    public Schedule save(Schedule schedule) throws SQLException {
        String sql = """
            INSERT INTO schedules (member_name, arrival_date, arrival_time, station, memo, dinner_status)
            VALUES (?, ?, ?, ?, ?, ?)
        """;
        ...
        try (Connection conn = Database.connect();
            ...
            stmt.setString(6, schedule.dinnerStatus);
    ...
    private Schedule mapRow(ResultSet rs) throws SQLException {
        ...
        s.dinnerStatus = rs.getString("dinner_status");
